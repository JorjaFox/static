...
file_get_contents("http://jorjafox.net/content/code/ads/adboxes.php?name=halfbanner-234x60.php");

file_get_contents("http://jorjafox.net/content/code/ads/adboxes.php?name=line-buttons-500x250");
